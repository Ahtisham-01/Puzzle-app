    ...
    return (
        <div className="w-full p-7  h-screen  ">
            <div className="w-full  p-4  border border-zinc-300 bg-zinc-50 rounded-md">
                ...
                />
                <div className="flex w-full justify-end items-center object-cover h-24 rounded-md  ">
                    <button className="text-white  bg-zinc-900 px-14 py-4 rounded-md text-[20px]">
                        Next
                    </button>
                </div>
